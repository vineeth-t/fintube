              ...
              <div className='profile-info'>
                   <div>
                     ...
                     <div className='media-content'>
                        <h5 style={{color:"white",marginBottom:'0.2rem',width:'30rem'}}>{videoPlayingNow.name}</h5>
                        ...
                        <div style={{display:"flex",alignItems:'center'}}>
                            <div onClick={()=>dispatch({type:'likedVideo',video:videoPlayingNow})} style={{marginRight:'0.5em',display:'flex',alignItems:'center'}} >
                            ...
                            <label style={{marginRight:'1em'}}>{videoPlayingNow.likes}</label>
                        ...
                        <div style={{display:'flex',alignItems:'center',marginLeft:'0.5em'}} onClick={()=>dispatch({type:'watchLater',video:videoPlayingNow})} >
